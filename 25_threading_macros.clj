...
;; (reduce + (into [] (filter even? (map inc (1 2 3 4 5))))
;; (reduce + (into [] (filter even? (2 3 4 5 6)))
;; (reduce + (into [] (2 4 6))
;; (reduce + [2 4 6])
;; 12
...
;; evaluates to:
;; (into [] (function-that-takes-a-coll "hello" "there" a-list-with-maps))
;; (into [] (function-that-takes-a-coll "hello" "there" ({:a 1} {:a 2} {:a 3})))
;; (into [] (1 2 3))
;; [1 2 3]
